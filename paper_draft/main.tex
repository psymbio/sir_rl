...
\subsection{Optimizing Window Length for Time-varying $\nu$}\label{optimizing_window_length}
...
\subsection{SIRV Model with Lockdown and time-varying $nu$}
...
See \Crefrange{fig:SIR_model_IND,fig:SIRV_model_with_lockdown_infections_time_varying_nu_IND} and \cref{fig:comparing_costs_IND} to see how the different models compare against each other.
...
\begin{figure}[H]
  ...
  \includegraphics[width=\linewidth]{images/comparing_costs_IND.pdf}
